...
export const NUMUNE_PRESETS = [
  {
    ...
    cfg: {
      ...
      rows: [
        ...
        { toolNo: '6', depth: 6, stepOffset: 59, absoluteOffset: 59, name: '6mm kaba boşaltma (iç, dik köşe)', operation: 'offset', roughing: true },
        { toolNo: '6', depth: 6, stepOffset: 70, absoluteOffset: 65.76, cornerRadius: 6, name: '6mm dış rounded offset', operation: 'offset' },
        { toolNo: '6', depth: 6, stepOffset: 70, absoluteOffset: 67.88, cornerRadius: 3, name: '6mm iç rounded offset', operation: 'offset' },
