// shared/gcode/common.js
// Small shared helpers used across every gcode module, by BOTH the client and
// the server. This is the canonical copy — client/src/lib/gcode/common.js is a
// re-export shim pointing here so client-side imports keep working, and the
// server imports this file directly instead of reaching into client/src.
// Kept dependency-free (no DOM, no React) so it can be unit tested anywhere.
